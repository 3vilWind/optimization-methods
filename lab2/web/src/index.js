...
import {ConjugateGradientMethod, GradientDescent, GradientSteepestDescent} from "./methods";
...
function renderMethods() {
    for (const method of methods) {
        ...
        methodsPanel.lastChild.addEventListener("click", (e) => {
            ...
            const aXX = parseFloat(document.querySelector("#a-xx").value);
            const aXY = parseFloat(document.querySelector("#a-xy").value);
            const aYY = parseFloat(document.querySelector("#a-yy").value);

            const bX = parseFloat(document.querySelector("#b-x").value);
            const bY = parseFloat(document.querySelector("#b-y").value);
...
function initXYSync() {
    const aYX = document.querySelector("#a-yx");
    document.querySelector("#a-xy").addEventListener("change", (event) => {
        aYX.value = event.target.value;
    });
}
